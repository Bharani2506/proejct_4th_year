...
if(isset($_POST['submit'])){
    ...
    $emp_id= $_POST['emp_id'];
    $present_data= $_POST['present_data'];
    $status  = 'unblock';

  
    $sql = "INSERT INTO attendance( `emp_id`, `present_data`, `status`)
    VALUES ('$emp_id','$present_data','$status')";
            ...
            <div class="col-lg-12">
                  ...
                  <div class="form-group">
                    <label class="control-label">Date:</label>
                      <input required type="date" class="form-control" name="present_data">
                  </div>
